...
This is the single index of content-worthy stories and observations. Detailed notes may live elsewhere; every idea should still have one row here.
...
| ID | Series | Working title | Core lesson | Status | Source location | Next action |
| --- | --- | --- | --- | --- | --- | --- |
| STORY-001 | Marketing Beyond Marketing | ROAS versus business ROI | Strong campaign metrics do not automatically mean profitable business growth. | Scheduled; publication confirmation pending | [MBM-001](../01-LinkedIn/Marketing-Beyond-Marketing/MBM-001/) | Confirm publication, then capture metrics. |
| STORY-002 | Build With Vikash | Ideas do not build products; systems do | Building exposed the importance of Git, repositories, worktrees, integrations, testing, and recovery. | Scheduled; publication confirmation pending | [BWV-001](../01-LinkedIn/Build-With-Vikash/BWV-001/) | Confirm publication, then capture metrics. |
...
Use [the five-minute idea capture template](02_IDEA_CAPTURE_TEMPLATE.md), then add a summary row above.

## Story Bank Rules

- Do not create a second Story Bank in another folder.
- Link to the source rather than copying full approved posts here.
- Do not mark a story `Published` without a confirmed public URL or publishing record.
- Merge overlapping ideas instead of producing repetitive posts.
- Review sensitive stories before any external drafting.
